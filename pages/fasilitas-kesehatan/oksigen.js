...
export default function FasilitasKesehatan() {
  const siteInfo = {
    ...
    description:
      'Daftar Oksigen di kota Sidoarjo. Fasilitas Penunjang Kesembuhan COVID-19 kota Sidoarjo',
    image: 'opengraph.jpg',
    url: 'https://covid.sda.untukkita.my.id',
    pageDescription: 'Kumpulan data oksigen yang terdapat di kota Sidoarjo',
    pageTitle: 'Data Oksigen di Kota Sidoarjo',
  };
...
function CardFasilitasKesehatan() {
  const { data, error } = useSWR('/api/data/faskes/oksigen', fetcher);
